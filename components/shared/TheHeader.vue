<template>
  <q-header class="the-header q-py-md">
    <div class="container-md flex items-center">
      <div class="the-header__name flex items-center">
        ...
        <NuxtLink class="text-link" :to="localePath('/')">Events</NuxtLink>
      </div>
      <q-space />
...
.the-header {
  ...
  font-size: 18px;
  font-family: "Ubuntu", "Roboto", "-apple-system", "Helvetica Neue", Helvetica,
    Arial, sans-serif;
  font-weight: 500;
  left: 16px !important;
  ...
  &.q-dark .the-header__logo {
    &:after {
      background-color: rgba(255, 255, 255, 0.5);
    }
  }
  &.q-dark .logo-pic__item--dark,
  &.q-dark .logo-pic__item--light {
    fill: white;
  }
}
</style>
